...
The demo image can be downloaded from the releases page on GitHub or by following the link from the download page on the Ultibo website. If you don’t have a Raspberry Pi a video of the demo is available on [YouTube](https://youtu.be/GF9Xbf3mbf4)

To run the demo unzip the downloaded file (Ultibo-Demo-1.0.15.zip), copy the contents to the root directory of an SD card formatted with a FAT partition and use the card to boot your Raspberry Pi. 
...
For more information on Ultibo and what it can do visit the [Ultibo.org website](https://ultibo.org/)
