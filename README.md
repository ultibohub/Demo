...
To run the demo unzip the downloaded file (Ultibo-Demo-1.0.14.zip), copy the contents to the root directory of an SD card formatted with a FAT partition and use the card to boot your Raspberry Pi. 
